...
export function UserProfile() {
  ...
  const getInitials = (name: string) => {
    ...
    // Handle single word names (like usernames from email)
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border hover:bg-accent transition-colors">
                  ...
                  <Button
                    variant="outline"
                    onClick={() => {
                      // Use email username as default if current name is a default name
                      const currentName = user?.name || '';
                      const emailUsername = user?.email ? user.email.split('@')[0] : '';
                      const isDefaultName = currentName === 'John Doe' || currentName === 'User' || currentName === '';
                      
                      setEditName(isDefaultName ? emailUsername : currentName);
