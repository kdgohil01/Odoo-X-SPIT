...
export function ReceiptDetail() {
  ...
  const handleValidate = () => {
    ...
    toast.success('Receipt validated successfully!', {
      description: `${receipt.documentNumber}: ${totalItems} items validated for ${receipt.lines.length} product(s). No stock changes made.`,
    });
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will mark the receipt as validated and completed. No stock levels will be affected. This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
