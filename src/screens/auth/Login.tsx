...
export function Login() {
  ...
  // Clear all form values when component mounts (on refresh or first load)
  useEffect(() => {
    ...
    setSignupPassword('');
    setConfirmPassword('');
    setFormKey(Date.now()); // Force re-render to clear any cached values
    
    // Clear any potential form data from browser cache
    ...
    // Clear any input values that might be cached
    setTimeout(() => {
      ...
      <div id="container" className={isFlipped ? 'active' : 'close'}>
        ...
        <div className="login">
          <div className="content">
            ...
            <form onSubmit={handleLogin} autoComplete="off" key={`login-${formKey}`}>
              <Input
                type="email"
                placeholder="Email"
                value={email}
                ...
                autoCapitalize="off"
                spellCheck="false"
                name={`login-email-${formKey}`}
                id={`login-email-${formKey}`}
              />
              <Input
                type="password"
                ...
                autoCapitalize="off"
                spellCheck="false"
                name={`login-password-${formKey}`}
                id={`login-password-${formKey}`}
              />
        ...
        <div className="register">
          <div className="content">
            ...
            <form onSubmit={handleSignup} autoComplete="off" key={`signup-${formKey}`}>
              <Input
                type="text"
                placeholder="Name"
                value={name}
                ...
                spellCheck="false"
                name={`signup-name-${formKey}`}
                id={`signup-name-${formKey}`}
              />
              <Input
                type="email"
                placeholder="Email"
                ...
                autoCapitalize="off"
                spellCheck="false"
                name={`signup-email-${formKey}`}
                id={`signup-email-${formKey}`}
              />
              <Input
                type="password"
                placeholder="Password"
                ...
                autoCapitalize="off"
                spellCheck="false"
                name={`signup-password-${formKey}`}
                id={`signup-password-${formKey}`}
              />
              <Input
                type="password"
                ...
                autoCapitalize="off"
                spellCheck="false"
                name={`signup-confirm-${formKey}`}
                id={`signup-confirm-${formKey}`}
              />
              <div className="flip-form-options">
                <span className="remember">
